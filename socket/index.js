...
module.exports = function (socket) {
  ...
  socket.on('infos', function (infos) {
    ...
    //socket.request.session.rdp.header.background &&
    socket.emit('headerBackground', socket.request.session.rdp.header.background)
    //socket.request.session.rdp.header.name &&
    socket.emit('header', socket.request.session.rdp.header.name)
